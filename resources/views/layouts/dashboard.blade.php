                ...
                <div class="flex justify-between py-2 px-2">
                    ...
                    <div x-data="{ isOpen: false }" class="relative">
                        ...
                        <button @click="isOpen = !isOpen" class="flex items-center space-x-1 md:hidden">
                            ...
                            <!-- X Icon when open -->
                            <svg x-show="isOpen" x-cloak xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="items-center hidden md:flex">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class=" flex items-center bg-red-500 text-gray-50 hover:bg-red-700 px-4 py-1 rounded-lg font-semibold">
